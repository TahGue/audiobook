    ...
    <div className="max-w-4xl mx-auto p-6">
        ...
        <form onSubmit={handleCreateChapter} className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md mb-6">
          <div className="space-y-4">
            <input
              ...
              autoFocus
            />
            <PdfUpload onTextExtracted={setContent} />
            <textarea
              value={content}
      ...
      <div className="space-y-4">
        {project.chapters?.map((chapter) => (
          <div key={chapter.id} className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
              {chapter.audio_path && (
                <AudioPlayer audioUrl={`/audio/${project.id}/${chapter.id}.wav`} duration={chapter.duration_seconds} />
              )}
